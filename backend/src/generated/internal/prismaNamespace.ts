...
> = {
  ...
  meta: {
    modelProps: 'user' | 'event' | 'orders' | 'balance';
    ...
    Orders: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.OrdersCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type OrdersOrderByRelevanceFieldEnum =
  (typeof OrdersOrderByRelevanceFieldEnum)[keyof typeof OrdersOrderByRelevanceFieldEnum];
